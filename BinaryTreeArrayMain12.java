public class BinaryTreeArrayMain12 {
    public static void main(String[] args) {
        ...
        Mahasiswa12[] dataMahasiswa12 = {mhs1, mhs2, mhs3, mhs4, mhs5, mhs6, mhs7, null, null, null};
        int idxLast = 6;
        bta.populateData(dataMahasiswa12, idxLast);
        ...
        System.out.println("\nTambah satu mahasiswa ke binary tree array:");
        Mahasiswa12 mhs8 = new Mahasiswa12("244160250", "Ghina", "A", 3.92);
        bta.add(mhs8);
